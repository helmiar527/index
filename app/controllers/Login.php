...
class Login extends Controller {
  public function __construct() {
    if (!isset($_SESSION['status']) || $_SESSION['status'] !== "logged") {} else {
  ...
  public function login() {
    ...
    if ($row == false) {
      Flasher::setFlash('danger', 'Akun ', 'Tidak dapat ditemukan! ', 'Silahkan daftar terlebih dahulu.');
      ...
      if (password_verify($passcheck, $passhash)) {
