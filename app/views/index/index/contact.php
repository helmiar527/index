    ...
    <div class="row gx-4 gx-lg-5 justify-content-center">
      <div class="col-lg-8 col-xl-6 text-center">
        ...
        <p class="text-muted mb-5" data-aos="fade-down">
          Kirimkan pesan untuk mengirim masukkan web dan pemberitahuan bug yang ada.
        </p>
      </div>
    </div>
    <div class="row gx-4 gx-lg-5 justify-content-center mb-5">
      <div class="col-lg-6">
        ...
        <form class="needs-validation" name="sendtoadmin" novalidate>
          ...
          <input type="hidden" id="device" name="device" value="<?= $_SERVER['HTTP_USER_AGENT']; ?>" required>
          <div class="d-grid">
