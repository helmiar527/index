        ...
        <div class="col-12 grid-margin stretch-card">
          <div class="card">
            <div class="card-body">
              ...
              <form class="forms-sample needs-validation" name="formaddpengeluaran" method="post" novalidate>
                ...
                <div class="form-group">
                  <label for="tambahpengeluaran">Sumber Pengeluaran</label>
                  <input type="text" class="form-control" id="tambahpengeluaran" name="tambahpengeluaran" placeholder="Pengeluaran" required>
                </div>
                <div class="form-group">
                  <label for="tambahjumlah">Jumlah</label>
                  <input type="text" class="form-control" id="tambahjumlah" name="tambahjumlah" placeholder="Jumlah" required>
                </div>
                <div class="form-group">
                ...
                <input type="hidden" id="tambahtotal" name="tambahtotal">
                <div class="form-group">
...
<div class="modal fade" id="editModal" tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="editModalLabel">Edit Pengeluaran</h1>
        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
      </div>
      <div class="modal-body">
        <div class="col-12 grid-margin stretch-card">
          <div class="card">
            <div class="card-body">
              ...
              <form class="forms-sample needs-validation" name="formeditpengeluaran" method="post" novalidate>
                ...
                <div class="form-group">
                  <label for="editpengeluaran">Sumber Pengeluaran</label>
                  <input type="text" class="form-control" id="editpengeluaran" name="editpengeluaran" placeholder="Pengeluaran" required>
                </div>
                <div class="form-group">
