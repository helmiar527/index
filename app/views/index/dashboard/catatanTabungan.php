      ...
      <div class="row">
        <div class="col">
          <div class="form-group">
            ...
            <select class="js-example-basic-single form-select form-control" id="submitButtonUrutan" name="urutan" style="width:100%">
        ...
        <div class="col">
          <div class="form-group">
            <div class="input-group mt-4">
              <input type="text" class="form-control" placeholder="Searching" id="searching" name="searching" aria-label="Searching" aria-describedby="basic-addon2">
              <div class="input-group-append">
                <button class="btn btn-sm btn-primary" id="submitButtonSearch" type="submit">Search</button>
        ...
        <div class="col-12 grid-margin stretch-card">
          <div class="card">
            <div class="card-body">
              ...
              <form class="forms-sample needs-validation" name="formaddtabungan" method="post" novalidate>
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="tambahtabungan" name="tambahtabungan" placeholder="Tabungan" required>
                </div>
                <div class="form-group">
...
<div class="modal fade" id="editModal" tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="editModalLabel">Edit Tabungan</h1>
      ...
      <div class="modal-body">
        <div class="col-12 grid-margin stretch-card">
          <div class="card">
            <div class="card-body">
              <div class="notif-alert-edit">
              </div>
              <form class="forms-sample needs-validation" name="formedittabungan" method="post" novalidate>
                ...
                <div class="form-group">
                  <label for="edittabungan">Sumber Tabungan</label>
                  <input type="text" class="form-control" id="edittabungan" name="edittabungan" placeholder="Tabungan" required>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <p class="mt-3">Status <span class="text-danger">Unconfirm</span> adalah tabungan yang nominalnya belum masuk tetapi di catat dulu.</p>
                  <p class="mt-1">Status <span class="text-success">Confirm</span> adalah tabungan yang nominalnya sudah masuk dan di catat.</p>
                </div>
