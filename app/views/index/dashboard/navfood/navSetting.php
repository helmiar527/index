<nav class="sidebar sidebar-offcanvas" id="sidebar">
  ...
  <ul class="nav">
    <li class="nav-item nav-category">
      <span class="nav-link">Navigation Settings</span>
    </li>
    <li class="nav-item menu-items">
      <a class="nav-link" href="<?= BASEURL; ?>/dashboard/settings">
    ...
    <li class="nav-item menu-items">
      <a class="nav-link" href="<?= BASEURL; ?>/dashboard/profileSetting">
        <span class="menu-icon">
    ...
    <li class="nav-item menu-items">
      <a class="nav-link" href="<?= BASEURL; ?>/dashboard/accountSetting">
        <span class="menu-icon">
